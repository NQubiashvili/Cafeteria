                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="lblIsActive" runat="server" Text='<%# Eval("Status") %>'
                                                                        CssClass ='<%# Eval("Status").ToString() == "მიტანილია" ? "badge badge-success" : "badge badge-warning" %>'>
                                                                    </asp:Label>
                                                                </td>
                                                                <td><%# Eval("Name") %> </td>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:DropDownList ID="ddlOrderStatus" runat="server" CssClass="form-control">
                                                            ...
                                                            <asp:ListItem>მუშავდება</asp:ListItem>
                                                            <asp:ListItem>მიღებულია</asp:ListItem>
                                                            <asp:ListItem>მიტანილია</asp:ListItem>
                                                            <asp:ListItem>გადასახდელია</asp:ListItem>
                                                        </asp:DropDownList>
