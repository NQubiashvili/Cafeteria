<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="Cafeteria.Admin.Report" %>
                                ...
                                <div class="card-header">
                                    <div class="container">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <asp:Button ID="btnSearch" runat="server" Text="მოძებნა" CssClass="btn btn-primary mt-md-4"
                                ...
                                <div class="card-block">
                                    <div class="row">
                                        ...
                                        <div class="col-12 mobile-inputs">
                                            <h4 class="sub-title">გაყიდვების რეპორტები</h4>
